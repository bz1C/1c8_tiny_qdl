...
// Модуль ББР_ПолучениеДанных. Версия 1.3 от 04.05.2023
...
Функция ЗначенияРеквизитовОбъектовРазныхТаблиц_СформироватьОбъединенныйЗапрос(СоотвСсылкиПоТипам, СоотвРеквизитыПсевдонимРазбивка, ТолькоРазрешенные)
	...
	Для каждого СсылкиПоТипу Из СоотвСсылкиПоТипам Цикл
		...
		Для каждого Реквизит Из СоотвРеквизитыПсевдонимРазбивка Цикл		
			...
			// TODO: проверку наличия реквизита производим пока упрощенно. Для справочников, документов и ПВХ отработает, правда без учета общих реквизитов и реквизитов в расширении.
			Если мдСсылки.Реквизиты.Найти(Реквизит1Уровня) = Неопределено Тогда
